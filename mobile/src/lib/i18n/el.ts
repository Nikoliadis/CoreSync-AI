...
export const el: Messages = {
  ...
  // ------------------------------------------------------------------- photos
  "photos.title": "Φωτογραφίες προόδου",
  "photos.privacyNote":
    "Τις βλέπεις μόνο εσύ. Τα δεδομένα τοποθεσίας αφαιρούνται από κάθε φωτογραφία πριν αποθηκευτεί, και οι σύνδεσμοι που χρησιμοποιεί αυτή η οθόνη λήγουν σε λίγα λεπτά.",
  "photos.pose.front": "Μπροστά",
  "photos.pose.side": "Πλάι",
  "photos.pose.back": "Πίσω",
  "photos.add": "Πρόσθεσε φωτογραφία",
  "photos.empty":
    "Τίποτα ακόμα. Ίδιο σημείο, ίδιο φως, ίδια ώρα — η συνέπεια είναι που δίνει νόημα στη σύγκριση.",
  "photos.apart": "διαφορά",
  "photos.poseMismatch": "Είναι διαφορετικές πόζες, οπότε η σύγκριση δεν λέει πολλά.",
  "photos.photoFrom": "Φωτογραφία από {date}",
  "photos.processing": "Επεξεργασία",
  "photos.failed": "Δεν έγινε επεξεργασία",
  "photos.deleteTitle": "Διαγραφή της φωτογραφίας;",
  "photos.deleteBody": "Το αρχείο διαγράφεται οριστικά. Δεν αναιρείται.",
  "photos.deleteHint": "Παρατεταμένο πάτημα για διαγραφή",
  "photos.permissionTitle": "Η πρόσβαση στις φωτογραφίες είναι κλειστή",
  "photos.permissionBody":
    "Το CoreSync χρειάζεται πρόσβαση στη βιβλιοθήκη φωτογραφιών σου για να προσθέσει φωτογραφία προόδου.",
