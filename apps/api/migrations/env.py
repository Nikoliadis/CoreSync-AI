...
one source of configuration truth and no credential in version control.
"""
...
from coresync.infrastructure.database.models import Base
...
def do_run_migrations(connection: Connection) -> None:
    context.configure(
        ...
        compare_server_default=True,
        include_object=include_object,
        # Long identifiers are truncated rather than silently colliding.
